      ...
      <main id="top">
        <section className="hero" id="tournament">
          ...
          <div className="shell hero-content">
            ...
            <div className="actions"><Magnet magnetStrength={3} padding={90}><a className="btn btn-primary" href={withBase("/register")}>🏏 JOIN DPL 2026 →</a></Magnet></div>
