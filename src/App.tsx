      ...
      <main id="top">
        <section className="hero" id="tournament">
          ...
          <div className="shell hero-content">
            ...
            <div className="actions"><Magnet magnetStrength={3} padding={90}><a className="btn btn-primary" href="/D2P/register">🏏 JOIN DPL 2026 →</a></Magnet><Magnet magnetStrength={3} padding={90}><a className="btn btn-secondary" href="#teams">VIEW TOURNAMENT</a></Magnet></div>
