    ...
    >
      <motion.div
        variants={{
          ...
          active: { scale: 1, backgroundColor: 'var(--purple)', color: 'var(--purple)' },
          complete: { scale: 1, backgroundColor: 'var(--purple)', color: '#3b82f6' },
        }}
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants: Variants = {
    ...
    complete: { width: '100%', backgroundColor: 'var(--purple)' },
  };
