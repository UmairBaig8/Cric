...
export type DepthCarouselItem = string | { image?: string; alt?: string; content?: ReactNode };
...
const normalizeItem = (it: DepthCarouselItem) => (typeof it === 'string' ? { image: it, alt: '', content: undefined } : { image: it.image ?? '', alt: it.alt ?? '', content: it.content });
