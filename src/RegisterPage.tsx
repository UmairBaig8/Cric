...
export default function RegisterPage() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    setMessage('');
    try {
      const trimmed = { ...form, name: form.name.trim(), email: form.email.trim().toLowerCase(), department: form.department.trim() };
